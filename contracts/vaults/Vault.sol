...
import "../interfaces/airlift/IStrategy.sol";
 ...
 */
contract AirliftVaultV1 is ERC20, Ownable, ReentrancyGuard {
    ...
    // temp: Debug
    function withdrawAmount(uint256 _shares) public view returns (uint256) {
        uint256 r = (balance().mul(_shares)).div(totalSupply());
        return r;
    }
